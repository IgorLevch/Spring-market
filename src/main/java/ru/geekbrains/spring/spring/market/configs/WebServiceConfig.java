...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean(servlet, "/market/*");
    }

    // http://localhost:8080/market/groups.wsdl
    @Bean(name = "groups")
    public DefaultWsdl11Definition groupsWsdl11Definition(XsdSchema groupsSchema) {
        ...
        wsdl11Definition.setLocationUri("/market");
        wsdl11Definition.setTargetNamespace("http://www.geekbrains.ru/spring/spring/market/groups");
    ...
    public DefaultWsdl11Definition studentsWsdl11Definition(XsdSchema studentsSchema) {
        ...
        wsdl11Definition.setLocationUri("/market");
        wsdl11Definition.setTargetNamespace("http://www.geekbrains.ru/spring/spring/market/students");
